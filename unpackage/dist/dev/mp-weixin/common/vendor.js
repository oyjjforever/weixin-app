...
function initRuntimeSocketService() {
  const hosts = "192.168.10.108,10.17.18.72,192.168.126.1,169.254.196.49,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_wnfRNY";
...
const tabBar = {
  ...
  list: [
    ...
    },
    {
      ...
      selectedIconPath: "static/tabbar/case_.png",
      text: "案例"
    },
    {
      pagePath: "pages/contact/index",
      iconPath: "static/tabbar/contact.png",
      selectedIconPath: "static/tabbar/contact_.png",
      text: "联系我们"
    }
  ]
};
